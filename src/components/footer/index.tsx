...
export default function Footer(){
    return(
        <div className="flex flex-wrap md:flex-col mx-auto bg-[#911F27] text-center w-full mt-24 py-8 min-h[250px] ">
            ...
            <div className="flex flex-col items-end px-8">
                <p className="text-[#F2EBD5] text-2xl underline">Redes Sociais</p>
