  ...
  return (
    <div className="flex flex-col lg:flex-row mx-auto bg-[#911F27] text-center w-full py-8 min-h[250px] items-center lg:items-start justify-between">
      ...
      <div className="flex flex-col px-8 justify-start">
        <p className="text-[#F2EBD5] text-3xl underline mb-1 flex items-end">
          Redes Sociais
        </p>
        <div className="flex flex-wrap gap-4">
          <Link href="/">
            <Instagram size={40} className="text-[#F2EBD5]" />
          </Link>
          <Link href="/">
            <Linkedin size={40} className="text-[#F2EBD5]" />
          </Link>
          <Link href="/">
            <Facebook size={40} className="text-[#F2EBD5]" />
          </Link>
        </div>
      </div>
    </div>
