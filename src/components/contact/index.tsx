      ...
      <div className="flex flex-col flex-grow justify-center p-4 gap-16 w-4/12">
        ...
        <form className="flex flex-col gap-4 ">
          <input
            type="text"
            placeholder="Nome"
            className="p-3 required bg-[#F2EBD5]"
          />
          <input
            type="text"
            placeholder="Email"
          ...
          <textarea
            ...
            rows={5}
            className="p-3 resize-none bg-[#F2EBD5]"
          />
          <div className="h-[1px] bg-[#F2EBD5] my-2" />
          <button className="w-10/12 lg:w-8/12 m-auto bg-[#F2EBD5] text-[#911F27] mt-0 hover:bg-[#F2EBD5]/90 py-4 px-5 rounded-md text-lg 2xl:text-2xl font-semibold transition-all">
            Entrar em contato
          </button>
        </form>
      </div>
